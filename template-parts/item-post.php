...
$post_classes = array(
    ...
    !$has_thumbnail ? $accent_classes[$post_index % count($accent_classes)] : false,
...
?>
<a href="<?= esc_url($post_permalink); ?>" class="<?= esc_attr(implode(' ', array_map('sanitize_html_class', array_filter($post_classes)))); ?>">
    ...
    <?php endif; ?>
    <div class="content">
        <h3 class="h4-size title"><?= esc_html($post_title); ?></h3>
        <div class="metas">
        ...
        <span class="sr-only"><?= sprintf(esc_html__('Read more about %s', 'around-the-wereld'), esc_html($post_title)); ?></span>
    </div>
</a>
